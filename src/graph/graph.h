...
private:
    ...
    bool flag = true;
public:
    Edge(uint v1_, uint v2_, uint v1Label_, uint v2Label_, uint eLabel_, float eweight_) : v1(v1_), v2(v2_),
                                                                                           v1Label(v1Label_),
                                                                                           v2Label(v2Label_),
                                                                                           eLabel(eLabel_),
                                                                                           eWeight(eweight_) {
    ...
    Edge(uint v1_, uint v2_, uint eLabel_) : v1(v1_), v2(v2_), eLabel(eLabel_) {
    }
